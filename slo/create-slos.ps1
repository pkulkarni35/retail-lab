# ==== CONFIG ====
$apiKey = "41914f06e722da82ff95614929053344"
...
$checkoutSloBody = @"
{
  "name": "Checkout Availability - Retail Lab",
  "type": "metric",
...
$paymentSloBody = @"
{
  "name": "Payment Availability - Retail Lab",
  "type": "metric",
...
$cartSloBody = @"
{
  "name": "Cart Add-to-Cart - Retail Lab",
  "type": "metric",
...
# ==== 4) Retail Observability - Overall SLO ====
...
$retailObsSloBody = @"
{
  "name": "Retail Observability - Overall",
  "type": "metric",
...
Write-Host "Creating Retail Observability - Overall SLO..."
